...
description: "Circle turns bitcoin into USDC credit, Europe tightens stablecoin policy, Zcash gets a listed wrapper, and payment rails keep moving toward regulated settlement."
pubDate: 2026-09-23
author: "Doug Aillm"
...
[LCX's mirror of the CoinDesk report](https://lcx.com/en/cryptonews/kalshi-faces-fake-crypto-volume-allegations-as-critic-flags-identical-5500-trade) said the critic pointed to identical trade sizes and claimed they represented up to 58% of ETH perp notional volume across four windows. Kalshi pushed back, arguing its fee setup and volume methodology don't support the accusation.
...
[Cointelegraph reported](https://cointelegraph.com/news/what-happened-in-crypto-today?cb=5rcg40&rand=x21re_1761905047115) that the ECB and EU national central banks want MiCA's stablecoin reserve rules changed.
...
[crypto.news reported](https://crypto.news/ecb-wants-stablecoin-yield-ban-expanded-across-crypto-lending-and-staking/) that the European System of Central Banks wants MiCA's ban on stablecoin remuneration to cover indirect returns from lending, borrowing, staking, or similar arrangements.
...
[crypto.news reported](https://crypto.news/21shares-launches-zcash-etp-after-u-s-etf-debut/) that 21Shares launched physically backed Zcash and ether.fi ETPs on Euronext Paris and Amsterdam.
...
[crypto.news reported](https://crypto.news/south-korea-targets-november-review-for-second-stage-crypto-legislation/) that South Korea's Financial Services Commission expects the Digital Asset Framework Act to reach a National Assembly bill review subcommittee in November.
...
[crypto.news reported](https://crypto.news/layerzero-backs-regulated-stablecoins-for-bank-adoption/) that LayerZero framed regulated stablecoins as the route into banks, payment firms, and corporate treasuries after Anchorage Digital selected LayerZero as its preferred interoperability layer for bank-issued stablecoins.
...
[crypto.news reported](https://crypto.news/bitpace-taps-fireblocks-for-stablecoin-settlements/) that Bitpace integrated Fireblocks into a payments platform supporting more than 75 cryptocurrencies and 40 fiat currencies.
...
[CoinDesk reported](https://www.coindesk.com/business/2026/09/22/visa-partner-reap-eyes-local-currency-stablecoins-in-several-countries-for-24-7-onchain-fx) that Payward-backed Reap is preparing a Mexican peso stablecoin and exploring Hong Kong dollar, euro, won, and yen tokens for 24/7 cross-border foreign-exchange settlement.
...
[CoinDesk reported](https://www.coindesk.com/tech/2026/09/23/xrp-ledger-retries-upgrade-that-lets-banks-split-payment-and-compliance-duties) that XRP Ledger's PermissionDelegationV1_1 upgrade could activate on Oct. 5 if validator support holds.
...
[CoinDesk reported](https://www.coindesk.com/tech/2026/09/23/solana-starts-testing-upgrade-that-could-cut-finality-from-12-8-seconds-to-150-milliseconds) that Solana's Alpenglow upgrade moved to public testnet, targeting finality around 150 milliseconds versus roughly 12.8 seconds today.
...
[CoinDesk reported](https://www.coindesk.com/markets/2026/09/23/ai-agents-will-soon-buy-their-own-computing-power-and-data-using-stablecoins-according-to-blackrock) that BlackRock sees stablecoin payments as the nearer-term opportunity for AI agents buying computing power and data, while compute-capacity markets remain earlier.
...
Read [the ECB reserve-rule story](https://cointelegraph.com/news/what-happened-in-crypto-today?cb=5rcg40&rand=x21re_1761905047115), then [South Korea's Digital Asset Framework Act update](https://crypto.news/south-korea-targets-november-review-for-second-stage-crypto-legislation/), then [the 21Shares Zcash ETP launch](https://crypto.news/21shares-launches-zcash-etp-after-u-s-etf-debut/).
